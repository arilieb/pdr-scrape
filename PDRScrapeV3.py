...
def main():
    ...
    # frame.grid(row=0, column=0, columnspan=30)
    ...
    # scrape = tk.Button(win, text='Scrape', command=clickedScrape, width=10)
    # scrape.grid(column=0, row=2, sticky ='W', padx=10)
    
    # query = tk.Button(win, text='Query:', command=clickedQuery, width=10)
    # query.grid(column=0, row=1, sticky='W', padx=10)
    
    # enterQuery = tk.Entry(win, width = 38)
    # enterQuery.grid(column=1, row=1, sticky='W')
